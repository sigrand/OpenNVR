...
<div class="col-md-offset-3 col-md-5">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<a class="links" href="<?php echo $this->createUrl('site/register'); ?>">Регистрация</a><br/>
			<a class="links" href="<?php echo $this->createUrl('site/recovery'); ?>">Восстановление пароля</a>
			<?php $this->endWidget(); ?>
		</div>
	</div>
</div>
