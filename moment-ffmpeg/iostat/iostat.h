...
#ifdef __cplusplus
extern "C" void Run_iostat();
extern "C" void Close_iostat();
extern "C" void Get_stat_io(stat_io ** stat_io_out, int * stat_io_size_out);
extern "C" void Free_stat_io(stat_io ** stat_io_out);
#endif
